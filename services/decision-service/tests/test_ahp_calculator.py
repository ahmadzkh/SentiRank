...
def test_ahp_calculation_should_return_normalized_weights_and_cr() -> None:
...
def test_ahp_unknown_criterion_should_raise_value_error() -> None:
    comparisons = [
        AhpPairwiseComparison(criterion_a="C1", criterion_b="C2", value_a_over_b=3),
        AhpPairwiseComparison(criterion_a="C1", criterion_b="C4", value_a_over_b=5),
        AhpPairwiseComparison(criterion_a="C2", criterion_b="C3", value_a_over_b=2),
    ]
